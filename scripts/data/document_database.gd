...
static func _build() -> void:
	...
	_add("doc_br_crossover", "Damp Notebook", "L.M.", "—", "",
		"The wallpaper here smells like a hospital. Antiseptic and old fear. I keep thinking of Saint Veyra — the ward, the lower levels, the thing Voss made out of what he took from people.\n\nMaybe every wrong place leaks into every other wrong place. Maybe the no-clip isn't a hole in the wall. Maybe it's a hole in us.\n\n— if you find this, my name was Lena. I'm sorry, Eli.")
	_add("doc_hz_meg", "M.E.G. Outpost Notice", "M.E.G. — Habitable Zone Team", "—", "",
		"MAJOR EXPLORER GROUP — OUTPOST 7\n\n1. This zone is RELATIVELY safe. Relatively.\n2. Almond water is rationed. Take a crate, leave a crate.\n3. The freight door is your way down. It needs THREE level keys. We split them so no one panics and bolts alone.\n4. If you see the tall one — the one that walks wrong — do NOT let it close the distance. It is slow until you are near. Then it is not slow.\n\nKeep to the lit aisles. Keep moving. — Outpost 7")
	_add("doc_hz_graffiti", "Spray-painted Wall", "—", "—", "",
		"Huge letters dripping down a girder:\n\n  'THE DOOR DOWN IS NOT THE WAY OUT'\n  'LEVEL ! IS BELOW'\n  'THEY ARE STILL FILMING'\n\nUnderneath, smaller, almost polite:\n  'turn your camera off down here. it watches the lens.'")
	_add("doc_hz_freight", "Freight Door Procedure", "M.E.G. — Outpost 7", "—", "",
		"FREIGHT DOOR — EMERGENCY EGRESS\n\nThe door reads three keycards at once. We mag-locked it that way after Reyes tried to leave alone and brought the tall one back with him.\n\nFind all three. Insert together. The door opens for nine seconds. Be at the threshold BEFORE you have all three — do not go hunting keys with the door open. It comes when the door is open. Every time.\n\nGood luck, whoever you are. Tell them Outpost 7 held as long as it could.")
	_add("doc_hz_lena", "A Familiar Hand", "Lena Morel", "—", "lena_backrooms",
		"Another note, the handwriting the same as the damp notebook two floors up.\n\n'I keep finding my own messages ahead of me. I don't remember leaving them. Either the rooms loop, or I've been down here longer than a life.\n\nThe tall one wore a hospital attendant's whites when I first saw it. Now it wears something older. I think the Backrooms and Saint Veyra are the same wound, seen from two sides.\n\nIf you're my brother — and somehow I know you are — turn around. Please. There is no door that leads back to me. — L.'")
